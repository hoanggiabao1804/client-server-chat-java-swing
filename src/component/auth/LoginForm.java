...
public class LoginForm implements AppContext {
    ...
    public LoginForm(Container parent) {
        ...
        submitButton.addActionListener(l -> {
            ...
            if (!hasErrors) {
                String authenticatedResult = Authentication.getInstance().authenticate(this.username, this.password);
                if (authenticatedResult.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(null, authenticatedResult, "Đăng nhập không thành công",
