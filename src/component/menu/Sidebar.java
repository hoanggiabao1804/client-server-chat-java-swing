...
public class Sidebar implements AppContext {
    ...
    private JPanel createDialogTabPanel(Dialog dialog) {
        ...
        Message lastMsg = dialog.getMessages().isEmpty() ? null : dialog.getMessages().getLast();
    ...
    public void loadUser() {
        ...
        List<Dialog> dialogList = DialogRepository.getInstance().findByUserId(userLogin.getId().toString());
